...
import VideoNotes from "../VideoNotes/VideoNotes";
// import ReactPlayer from '../../../ReactPlayer/ReactPlayer';

export class VideoDetails extends Component {

    //  TODO: Create notes component
    state = {
        url: null,
        pip: true,
        playing: true,
    ...
    componentWillMount(){
      // Get the notes for the authUser
    }
                ...
                <section className="section_VIDEODETAILS">
                    <div className="videoControlsContainer_VIDEODETAILS">
                        <div className="player-wrapper_VIDEODETAILS">
                            ...
                            />
                            {/* VIDEO NOTES  */}
                            <VideoNotes videoId={this.props.videoId} courseId={this.props.courseId}></VideoNotes>
                        </div>
                        <div className="controlOverScreen_VIDEODETAILS">
                            <div className="containerControls_VIDEODETAILS">
                                <div className="playContainer_VIDEODETAILS">
                                    <button
                                        className="play_VIDEODETAILS"
                                        onClick={this.handlePlayPause}
                                    >
                                        {playing ? (
                                            <img
                                                className="iconVolumen_VIDEODETAILS"
                                                src="https://image.flaticon.com/icons/svg/151/151859.svg"
                                                alt=""
                                            ></img>
                                        ) : (
                                            <img
                                                className="iconVolumen_VIDEODETAILS"
                                                src="https://image.flaticon.com/icons/svg/149/149657.svg"
                                                alt=""
                                            ></img>
                                        )}
                                    </button>
                                ...
                                <div className="mutedContainer_VIDEODETAILS">
                                    <button
                                        className="muted_VIDEODETAILS"
                                        onClick={this.handleToggleMuted}
                                    >
                                        {muted ? (
                                            <img
                                                className="iconVolumen_VIDEODETAILS"
                                                src="https://image.flaticon.com/icons/svg/149/149687.svg"
                                                alt=""
                                            ></img>
                                        ) : (
                                            <img
                                                className="iconVolumen_VIDEODETAILS"
                                                src="https://image.flaticon.com/icons/svg/149/149682.svg"
                                                alt=""
                                            ></img>
                                        )}
                                    </button>
                                ...
                                <div className="velocityContainer_VIDEODETAILS">
                                    <div className="dropdown_VIDEODETAILS">
                                        <button className="dropbtn_VIDEODETAILS">
                                            <img
                                                className="iconVolumen_VIDEODETAILS"
                                                src="https://image.flaticon.com/icons/svg/0/128.svg"
                                                alt=""
                                            ></img>
                                        </button>
