...
const Carousel = () => (
  ...
  <div class="carousel-wrapper" style={{"height": "400px"}}>
      ...
      <h2 className="carousel-title">CURVERY</h2>
      <p className="carousel-paragraph" >La nueva plataforma de aprendizaje donde te olvidaras de las distracciones que tiene YouTube para que aproveches el tiempo</p>
      ...
      <div className="carousel-text">
      <h2 className="carousel-title">VE A TU RITMO</h2>
      <p className="carousel-paragraph" >Con CURVERY planea tus horarios y estudia cuando y donde puedas</p>
      <button>Registrate</button>
      </div>
      ...
      <div className="carousel-text">
      <h2 className="carousel-title">ES GRATIS</h2>
      <p className="carousel-paragraph" >Curvery es una plataforma donde encontraras cursos 100% gratis ya que creamos y buscamos listas apartir de un tema con los videos de Youtube</p>
      <button>Registrate</button>
      </div>
